...
def movies():
	html = """
		...
		<div class="mar">
		<h4><a href="/news_batman">Ben Affleck Now Indicates That He'll Be Ready To Shoot His Solo BATMAN Movie In The Spring</a></h2>
		<h5>Our last update on the progress of The Batman didn't seem particularly positive, but it now director Ben Affleck appears 
...
def news_batman():
	...
	html += '  <textarea rows="5" cols="150" name="comment">'
